...
<div class="hotel-card">
    ...
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
 </div><h1>skylight hotel</h1>
 <p class="near">Addis ababa</p>
 <a href="https://www.ethiopianskylighthotel.com/" class="hotel-book-now"> book-now</a>
</div>
<div class="hotel-card">
       
    <img src="assets/hotels5.jpg" alt="frendship addis ababa">
     <div class="hotel-star"><i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
 </div><h1> Kuriftu Resort</h1>
 <p class="near">Bishoftu</p>
 <a href="https://kurifturesorts.com/bishoftu/" class="hotel-book-now"> book-now</a>
</div>
<div class="hotel-card">
       
    <img src="assets/hotels6.jpg" alt="frendship addis ababa">
     <div class="hotel-star"><i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
 ...
 <p class="near">Arbaminch</p>
 <a href="https://hailehotelsandresorts.com/arbaminch_resort/" class="hotel-book-now"> book-now</a>
</div>
<div class="hotel-card">
    <img src="assets/hotels7.jpg" alt="frendship addis ababa">
     <div class="hotel-star"><i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
 </div><h1>Hills Resort</h1>
 <p class="near">Gondar</p>
 <a href="http://gondarhillsresort.com/ " class="hotel-book-now"> book-now</a>
</div>
<div class="hotel-card">
    <img src="assets/hotels8.jpg" alt="frendship addis ababa">
     <div class="hotel-star"><i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
 </div><h1>Central Hotel</h1>
 <p class="near">Jimma</p>
 <a href="#" class="hotel-book-now"> book-now</a>
</div>
<div class="hotel-card">
    <img src="assets/hotels9.jpg" alt="frendship addis ababa">
     <div class="hotel-star"><i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
 </div><h1> Saro-Maria Hotel</h1>
 <p class="near">Addis ababa</p>
 <a href="https://saromariahotel.com/" class="hotel-book-now"> book-now</a>
</div>
<div class="hotel-card">
    <img src="assets/hotels10.jpg" alt="frendship addis ababa">
     <div class="hotel-star"><i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
 </div><h1>Hyatt Regency</h1>
 <p class="near">Addis ababa</p>
 <a href="https://www.hyatt.com/hyatt-regency" class="hotel-book-now"> book-now</a>
</div>
  </section>
  <!-- Footer -->
