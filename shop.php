...
<section class="shop-cards">
    <div class="shop-card">
        ...
        <div class="price"><span>200$ - </span>
            <span class="price">$2000</span>
        </div>
        <a href="#">SELECT OPTIONS</a>
    </div>
    <div class="shop-card">
        <img src="assets/a2.jpg" alt="frendship addis ababa">
        <h1>Lalibela</h1>
        <div class="star-rating">
            <span class="star" data-value="1">&#9733;</span>
            <span class="star" data-value="2">&#9733;</span>
    ...
    <div class="shop-card">
        <img src="assets/a3.jpg" alt="frendship addis ababa">
        <h1>Danakil</h1>
        <div class="star-rating">
            <span class="star" data-value="1">&#9733;</span>
            <span class="star" data-value="2">&#9733;</span>
    ...
    <div class="shop-card">
        <img src="assets/a4.jpg" alt="frendship addis ababa">
        <h1>Omo Valley</h1>
        <div class="star-rating">
            <span class="star" data-value="1">&#9733;</span>
            <span class="star" data-value="2">&#9733;</span>
    ...
    <div class="shop-card">
        <img src="assets/a5.jpg" alt="frendship addis ababa">
        <h1>Bale Mount </h1>
        <div class="star-rating">
            <span class="star" data-value="1">&#9733;</span>
            <span class="star" data-value="2">&#9733;</span>
    ...
    <div class="shop-card">
        <img src="assets/a6.jpg" alt="frendship addis ababa">
        <h1>Kuriftu </h1>
        <div class="star-rating">
            <span class="star" data-value="1">&#9733;</span>
            <span class="star" data-value="2">&#9733;</span>
    ...
    <div class="shop-card">
        <img src="assets/a7.avif" alt="frendship addis ababa">
        <h1>Haile Resort</h1>
        <div class="star-rating">
            <span class="star" data-value="1">&#9733;</span>
            <span class="star" data-value="2">&#9733;</span>
    ...
    <div class="shop-card">
        <img src="assets/dp5.jpg" alt="frendship addis ababa">
        <h1>byenouna</h1>
        <div class="star-rating">
            <span class="star" data-value="1">&#9733;</span>
            <span class="star" data-value="2">&#9733;</span>
    ...
    <div class="shop-card">
        <img src="assets/dp6.jpg" alt="frendship addis ababa">
        <h1>haile resort</h1>
        <div class="star-rating">
            <span class="star" data-value="1">&#9733;</span>
            <span class="star" data-value="2">&#9733;</span>
    ...
    <div class="shop-card">
        <img src="assets/addis.jpg" alt="frendship addis ababa">
        <h1>Frendship</h1>
        <div class="star-rating">
            <span class="star" data-value="1">&#9733;</span>
            <span class="star" data-value="2">&#9733;</span>
